      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
          ...
          <div class="list-group">
            ...
            <a href="master-subject.html" class="list-group-item active">Master Subjek</a>
            ...
            <div class="col-md-12">
              <div class="panel panel-default address">
                ...
                <div class="panel-heading">
                  <h3 class="panel-title">Subjek &nbsp; <small><a href="insident-detail.html"><span class="label label-info">+ Tambah Subjek</span></a></small></h3>
                </div>
